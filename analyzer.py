...
def get_latest_annual_report(dart: OpenDartReader.OpenDartReader, corp_code: str) -> str | None:
    """최근 사업보고서 rcp_no 반환."""
    try:
...
def extract_sections(dart: OpenDartReader.OpenDartReader, rcp_no: str) -> dict:
    """
